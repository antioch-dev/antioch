// Centralized image sources for the Antioch Platform
// Using Unsplash and other free image APIs
...
export const ImageSources = {
  ...
  hero: {
    ...
    worship:
      'https://images.unsplash.com/photo-1507692049790-de58290a4334?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600&q=80',
    community:
      'https://images.unsplash.com/photo-1559027615-cd4628902d4a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600&q=80',
  },
  ...
  livestreams: {
    ...
    prayer:
      'https://images.unsplash.com/photo-1438032005730-c779502df39b?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&h=150&q=80',
    worship:
  ...
  about: {
    community:
      'https://images.unsplash.com/photo-1559027615-cd4628902d4a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80',
    mission:
      'https://images.unsplash.com/photo-1507692049790-de58290a4334?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80',
    vision:
      'https://images.unsplash.com/photo-1519491050282-cf00c82424b4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80',
  },

  // Video thumbnails (using video preview images)
  videos: {
    worship:
      'https://images.unsplash.com/photo-1507692049790-de58290a4334?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80',
    sermon:
      'https://images.unsplash.com/photo-1519491050282-cf00c82424b4?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80',
    testimony:
      'https://images.unsplash.com/photo-1559027615-cd4628902d4a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80',
    tutorial:
      'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300&q=80',
  },
  ...
  backgrounds: {
    ...
    gradient2:
      'https://images.unsplash.com/photo-1520637836862-4d197d17c90a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=800&q=80',
    texture:
  ...
  avatars: {
    pastor1:
      'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150&q=80&fit=facearea&facepad=2',
    pastor2:
      'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150&q=80&fit=facearea&facepad=2',
    leader1:
      'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150&q=80&fit=facearea&facepad=2',
    leader2:
      'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150&q=80&fit=facearea&facepad=2',
  },
}

// Helper function to get random image from a category
export function getRandomImage(category: keyof typeof ImageSources): string {
  const images = Object.values(ImageSources[category])
  return images[Math.floor(Math.random() * images.length)] ?? ImageSources.hero.background
}

// Helper function to get image with specific dimensions
export function getImageWithDimensions(url: string, width: number, height: number): string {
