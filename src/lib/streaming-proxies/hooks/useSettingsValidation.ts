...
interface UseSettingsValidationReturn {
  validateSetting: (setting: SettingValidation, value: string) => ValidationResult;
  validateMultipleSettings: (settings: Array<{ setting: SettingValidation; value: string }>) => Record<string, string>;
...
export function useSettingsValidation(): UseSettingsValidationReturn {
  ...
  const validateSetting = useCallback((setting: SettingValidation, value: string): ValidationResult => {
  ...
  const validateMultipleSettings = useCallback((
    settingsToValidate: Array<{ setting: SettingValidation; value: string }>
