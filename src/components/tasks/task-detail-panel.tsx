...
  // Added a useEffect to synchronize editedTask with selectedTask
...
      // Update the locally selected task to the new version
...
                  onValueChange={(value: TaskStatus) => setEditedTask((prev) => (prev ? { ...prev, status: value } : null))}
                >
