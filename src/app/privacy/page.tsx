        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              At Antioch Platform, we are committed to protecting your privacy and ensuring the security of your
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>Registering your fellowship on our platform</li>
              <li>Creating a user account</li>
              <li>Participating in fellowship activities</li>
              <li>Contacting us for support</li>
              <li>Subscribing to our newsletter or communications</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-900 mb-3">Fellowship Information</h3>
            <p className="text-gray-700 mb-4">When registering a fellowship, we collect:</p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>Fellowship name and description</li>
              <li>Location information (country, city)</li>
              <li>Leadership contact details</li>
              <li>Meeting information and schedules</li>
              <li>Ministry focus areas and languages</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700">
              ...
              <li>To process fellowship registrations and applications</li>
              <li>To facilitate communication within fellowships</li>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Within Your Fellowship</h3>
            <p className="text-gray-700 mb-4">
              Information you share within your fellowship (such as in fellowship directories or event participation)
              may be visible to other fellowship members as configured by your fellowship leaders.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              ...
              platform, conducting business, or serving our users, provided they agree to keep this information
              confidential.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              ...
              retention periods, we consider the nature of the information, potential risks from unauthorized use or
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700 mb-2">
                <strong>Email:</strong> privacy@antiochplatform.org
              </p>
              <p className="text-gray-700 mb-2">
                <strong>Address:</strong> Antioch Platform Privacy Team
              </p>
