...
import { type Event, mockFellowships, type Fellowship } from "@/lib/mock-data" 
...
    const fellowship = mockFellowships.find((f) => f.slug === fellowshipSlug) as (Fellowship & { events: Event[] }) | undefined

    return (fellowship?.events ?? []) 
  },
}
