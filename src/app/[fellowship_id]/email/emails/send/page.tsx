...
const isSingleString = (param: string | string[] | undefined): param is string => {
...
export default function SendEmailPage() {
    ...
    const rawFellowshipId = params.fellowship_id;
    const fellowshipId = isSingleString(rawFellowshipId) ? rawFellowshipId : undefined;

    const initialEmails = fellowshipId ? getSentEmailsByFellowship(fellowshipId) : [];
    const [sentEmails] = useState<SentEmail[]>(initialEmails)
    ...
    if (!fellowshipId) {
        console.error("Fellowship ID is missing or invalid in route parameters.");
        return (
            <div className="min-h-screen flex items-center justify-center bg-background">
                <p className="text-xl text-red-500 p-8 rounded-lg shadow-lg bg-card text-card-foreground">Error: Invalid **Fellowship ID** in URL. Please check the address.</p>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-background">
            {/* fellowshipId is guaranteed to be a string here */}
