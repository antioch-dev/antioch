...
export default function ServiceDetailPage() {
  ...
  const startServicePresentation = () => {
    router.push(`/fellowship1/shared_music/services/${params.id}/present`)
  }
  ...
  const handleDisplaySettings = () => {
    ...
    router.push(`/fellowship1/shared_music/services/${params.id}/settings`)
  }
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" asChild>
            <Link href={`/fellowship1/shared_music/services/${params.id}/edit`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <Link
                    href={`/fellowship1/shared_music/playlists/${serviceData.playlistId}`}
