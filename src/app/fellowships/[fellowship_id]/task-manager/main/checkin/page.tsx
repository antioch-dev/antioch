          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent>
              <Calendar
                ...
                // Removed default styling here to let custom CSS take over
                // className="rounded-md border-gray-600"
                initialFocus
                // Add a custom class to the Calendar for easier targeting
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-green-400 font-medium">{checkinsWithParsedDates.length}</span>
              </div>
            </CardContent>
          </Card>
        </div>
