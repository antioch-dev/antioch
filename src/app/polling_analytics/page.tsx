    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-12 md:py-24 lg:py-32 px-4">
          ...
          <div className="flex w-full max-w-[58rem] flex-col items-center justify-center gap-4 text-center mx-auto">
        ...
        <section className="py-12 md:py-24 lg:py-32 bg-muted/50 px-4">
         
          <div className="grid w-full gap-8 sm:grid-cols-2 md:grid-cols-3 mx-auto max-w-7xl">
            <Card>
              <CardHeader>
              ...
              <CardFooter>
                <Link href="/polling_analytics/dashboard/create" className="w-full">
            ...
            <Card>
              ...
              <CardFooter>
                <Link href="/polling_analytics/dashboard" className="w-full">
